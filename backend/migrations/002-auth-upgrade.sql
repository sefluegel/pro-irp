-- Migration 002: Production Authentication & Billing Structure
...
-- Add CHECK constraint for new role structure (Admin/FMO/Agency/Agent)
...
-- Next steps:
-- 1. Update your account to 'admin' role manually
-- 2. Run the updated backend code
