...
/**
 * HomeSimple — hero with laptop + phone mockups
 * Needs images in /frontend/public/img:
 *   - hero-laptop.png  (dashboard screenshot)
 *   - hero-phone.png   (client profile screenshot)
 */
...
export default function HomeSimple() {
  const laptopImg = "/img/hero-laptop.png";
  const phoneImg  = "/img/hero-phone.png";
      ...
      <main className="flex-1 py-10 sm:py-16">
        <C className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            >
              <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight" style={{ color: brand.navy }}>
                Next Generation Insurance <span style={{ color: brand.gold }}>Retention</span>
              </h1>
              <p className="mt-4 text-lg" style={{ color: brand.slate }}>
                Predict churn. Automate outreach. Protect renewals. Purpose-built for Medicare
          ...
          <div className="relative">
            ...
            <div className="relative mx-auto w-[720px] max-w-full">
              ...
              <div
                ...
                style={{ background: "#0e1620", border: "1px solid rgba(255,255,255,0.08)" }}
              >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 10px 25px rgba(0,0,0,.25), inset 0 2px 0 rgba(255,255,255,.6)",
                }}
              />
            </div>
            ...
            <div className="absolute -right-4 -bottom-6 w-[220px]">
              <div
                ...
                style={{ borderColor: "rgba(0,0,0,0.12)", background: "#0d0f14" }}
              >
                {/* Notch */}
