                  ...
                  >
                    {col.key === "select" ? (
                      <input
                        type="checkbox"
                        checked={
                          selected.length === filteredClients.length &&
            ...
            {filteredClients.map(c => (
              ...
              >
                ...
                {columns.includes("created") && (
                  <td className="py-1 px-2">{c.created}</td>
                )}
  ...
  >
    {tag}
                ...
                {columns.includes("owner") && (
                  <td className="py-1 px-2">{c.owner}</td>
                )}
      ...
      <div className="flex items-center justify-between mt-4 text-xs text-gray-500">
        <div>
          Total {filteredClients.length} record
